...
def solicitar_contraseña(accion):
    contraseñas = {"editar": "edit123", "añadir": "add123"}
    password = simpledialog.askstring("Contraseña", f"Ingrese la contraseña para {accion} productos:", show='*')
    return password == contraseñas[accion]
...
def mostrar_ventana_edicion(valores=None):
    if valores and not solicitar_contraseña("editar"):
        messagebox.showerror("Error", "Contraseña incorrecta para editar.")
        return
    if not valores and not solicitar_contraseña("añadir"):
        messagebox.showerror("Error", "Contraseña incorrecta para añadir.")
        return
...
def mostrar_ventana_principal():
    ...
    global tree
    tree = ttk.Treeview(ventana, columns=("Cod_Prod", "Descripcion", "Unidad", "Precio_Unit", "Precio_Iva", "Paga_Impuesto", "Existencia", "Observacion"), show="headings")
