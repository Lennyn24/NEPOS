...
def buscar_elemento():
    ...
    if descripcion:
        # Si la descripción contiene varias palabras, se busca cada palabra por separado
        palabras = descripcion.split()  # Divide la búsqueda en palabras
        subcondiciones = []
        for palabra in palabras:
            # Se busca la palabra en cualquier parte de la descripción
            subcondiciones.append("LOWER(Descripcion) LIKE ?")
            valores.append(f"%{palabra}%")  # Busca la palabra en cualquier parte de la descripción
